...
from utils.args import simclr_parser
from tasks.simclr import SimCLR_Rainbow
from utils.mypath import result_path


def main(args, game_name):
    args.game = game_name
    xid = f'simclr-{args.game}-{str(args.seed)}'
    args.id = xid
    ...
    curl_rainbow = SimCLR_Rainbow(args, results_dir)
    curl_rainbow.run_simclr_rainbow()


if __name__ == '__main__':
    parser = simclr_parser()
