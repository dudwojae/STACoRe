...
from singleagents.byol_agent import BYOLAgent
from tasks.byol_test import test
...
class BYOL_rainbow:
    def __init__(self, args, result_path):
        ...
        # define BYOL Rainbow Agent
        self.learner = BYOLAgent(args, self.env)
    ...
    def run_byol_rainbow(self):
        ...
        if self.args.evaluate:
            # Set BYOL_DQN (online network) to evaluation mode
            self.learner.eval()
            ...
            for T in trange(1, self.args.T_max + 1):
                ...
                if T >= self.args.learn_start:
                    ...
                    if T % self.args.replay_frequency == 0:
                        ...
                        # BYOL target network update
                        self.learner.update_byol_target_net()
                    ...
                    if T % self.args.evaluation_interval == 0:
                        ...
                        # Set BYOL_DQN (online network) back to training mode
                        self.learner.train()
