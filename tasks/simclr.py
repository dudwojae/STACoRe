...
from singleagents.simclr_agent import SimCLRAgent
from tasks.simclr_test import test


class SimCLR_Rainbow:
    def __init__(self, args: argparse, result_path: str):
        ...
        # Define SimCLR Rainbow Agent
        self.learner = SimCLRAgent(args, self.env)
    ...
    def run_simclr_rainbow(self):
        ...
        if self.args.evaluate:
            # Set SimCLR_DQN (online network) to evaluation mode
            self.learner.eval()
            ...
            for T in trange(1, self.args.T_max + 1):
                ...
                if T >= self.args.learn_start:
                    ...
                    if T % self.args.evaluation_interval == 0:
                        ...
                        # Set SimCLR_DQN (online network) back to training mode
                        self.learner.train()
